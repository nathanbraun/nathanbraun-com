...
globalStyles =
    ...
    , Css.Global.selector "[type='text'],input:where(:not([type])),[type='email'],[type='url'],[type='password'],[type='number'],[type='date'],[type='datetime-local'],[type='month'],[type='search'],[type='tel'],[type='time'],[type='week'],[multiple],textarea,select"
    ...
    , Css.Global.selector "[type='text']:focus, input:where(:not([type])):focus, [type='email']:focus, [type='url']:focus, [type='password']:focus, [type='number']:focus, [type='date']:focus, [type='datetime-local']:focus, [type='month']:focus, [type='search']:focus, [type='tel']:focus, [type='time']:focus, [type='week']:focus, [multiple]:focus, textarea:focus, select:focus"
    ...
    , Css.Global.selector "::-webkit-datetime-edit"
    ...
    , Css.Global.selector "[multiple],[size]:where(select:not([size=\"1\"]))"
    ...
    , Css.Global.mediaQuery [ "(forced-colors: active) " ]
        [ Css.Global.selector "[type='checkbox']:checked"
...
container =
    Css.batch
        [ Css.property "width" "100%"
        , Css.Media.withMediaQuery [ "(min-width: 2200px)" ]
            [ Css.property "max-width" "2200px"
            ]
        , Css.Media.withMediaQuery [ "(min-width: 1920px)" ]
            [ Css.property "max-width" "1920px"
            ]
...
form_checkbox =
    Css.batch
        ...
        , Css.Media.withMediaQuery [ "(forced-colors: active) " ]
            [ Css.pseudoClass "indeterminate"
                [ Css.property "appearance" "auto"
                ]
            ]
...
max_w_screen_xxl : Css.Style
max_w_screen_xxl =
    Css.property "max-width" "1536px"


max_w_screen_xxxl : Css.Style
max_w_screen_xxxl =
    Css.property "max-width" "1920px"


max_w_screen_xxxxl : Css.Style
max_w_screen_xxxxl =
    Css.property "max-width" "2200px"
...
prose =
    Css.batch
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose\\ >\\ \\:last-child):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-bottom" "0"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose\\ >\\ \\:first-child):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(figure):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(h4\\ +\\ \\*):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(h3\\ +\\ \\*):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(h2\\ +\\ \\*):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(hr\\ +\\ \\*):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0"
                ]
            ]
        , Css.Global.descendants
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(dl):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "1.25em"
                , Css.property "margin-bottom" "1.25em"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(ul\\ ul,\\ ul\\ ol,\\ ol\\ ul,\\ ol\\ ol):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose\\ >\\ ul\\ >\\ li\\ p):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0.75em"
                , Css.property "margin-bottom" "0.75em"
                ]
            ]
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(li):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0.5em"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(figcaption):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(tfoot):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "border-top-width" "1px"
                , Css.property "border-top-color" "var(--tw-prose-th-borders)"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(tbody\\ td):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "vertical-align" "baseline"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(tbody\\ tr\\:last-child):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "border-bottom-width" "0"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(tbody\\ tr):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "border-bottom-width" "1px"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(thead):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "border-bottom-width" "1px"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(pre\\ code):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))::after"
                [ Css.property "content" "none"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(pre\\ code):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))::before"
                [ Css.property "content" "none"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(pre\\ code):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "background-color" "transparent"
                , Css.property "border-width" "0"
                , Css.property "border-radius" "0"
                , Css.property "padding" "0"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(pre):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(thead\\ th\\ code):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "color" "inherit"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(blockquote\\ code):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "color" "inherit"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(h4\\ code):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "color" "inherit"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(h3\\ code):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "color" "inherit"
                , Css.property "font-size" "0.9em"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(h2\\ code):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "color" "inherit"
                , Css.property "font-size" "0.875em"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(h1\\ code):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "color" "inherit"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(a\\ code):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "color" "inherit"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(code):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))::after"
                [ Css.property "content" "\"`\""
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(code):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))::before"
                [ Css.property "content" "\"`\""
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(code):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(kbd):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "font-weight" "500"
                , Css.property "font-family" "inherit"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(picture):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "display" "block"
                , Css.property "margin-top" "2em"
                , Css.property "margin-bottom" "2em"
                ]
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(img):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "2em"
                , Css.property "margin-bottom" "2em"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(h4\\ strong):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "font-weight" "700"
                , Css.property "color" "inherit"
                ]
            ]
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(h3\\ strong):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "font-weight" "700"
                , Css.property "color" "inherit"
                ]
            ]
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(h2\\ strong):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "font-weight" "800"
                , Css.property "color" "inherit"
                ]
            ]
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(h1\\ strong):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "font-weight" "900"
                , Css.property "color" "inherit"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(h1):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "color" "var(--tw-prose-headings)"
                , Css.property "font-weight" "800"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(blockquote\\ p\\:last-of-type):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))::after"
                [ Css.property "content" "close-quote"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(blockquote\\ p\\:first-of-type):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))::before"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(dt):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "color" "var(--tw-prose-headings)"
                , Css.property "font-weight" "600"
                , Css.property "margin-top" "1.25em"
                ]
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(ul\\ >\\ li):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))::marker"
                [ Css.property "color" "var(--tw-prose-bullets)"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(ol\\ >\\ li):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))::marker"
                [ Css.property "font-weight" "400"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(ol\\[type=\"1\"\\]):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "list-style-type" "decimal"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(ol\\[type=\"i\"\\ s\\]):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(ol\\[type=\"i\"\\]):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "list-style-type" "lower-roman"
                ]
            ]
        , Css.Global.descendants
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(ol\\[type=\"a\"\\ s\\]):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(ol\\[type=\"a\"\\]):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "list-style-type" "lower-alpha"
                ]
            ]
        , Css.Global.descendants
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(thead\\ th\\ strong):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "color" "inherit"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(blockquote\\ strong):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "color" "inherit"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(a\\ strong):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "color" "inherit"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(strong):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "color" "var(--tw-prose-bold)"
                , Css.property "font-weight" "600"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(a):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(\\[class\\~=\"lead\"\\]):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(p):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "1.25em"
                , Css.property "margin-bottom" "1.25em"
                ]
            ]
...
prose_2xl =
    Css.batch
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose-2xl\\ >\\ \\:last-child):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-bottom" "0"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose-2xl\\ >\\ \\:first-child):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0"
                ]
            ]
        , Css.Global.descendants
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose-2xl\\ >\\ ul\\ >\\ li\\ p):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
...
prose_base =
    Css.batch
        ...
        , Css.property "line-height" "1.75"
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose-base\\ >\\ \\:last-child):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-bottom" "0"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose-base\\ >\\ \\:first-child):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0"
                ]
            ]
        , Css.Global.descendants
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose-base\\ >\\ ul\\ >\\ li\\ p):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0.75em"
                , Css.property "margin-bottom" "0.75em"
                ]
            ]
...
prose_lg =
    Css.batch
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose-lg\\ >\\ \\:last-child):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-bottom" "0"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose-lg\\ >\\ \\:first-child):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0"
                ]
            ]
        , Css.Global.descendants
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose-lg\\ >\\ ul\\ >\\ li\\ p):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0.8888889em"
                , Css.property "margin-bottom" "0.8888889em"
                ]
            ]
...
prose_sm =
    Css.batch
        ...
        , Css.property "line-height" "1.7142857"
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose-sm\\ >\\ \\:last-child):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-bottom" "0"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose-sm\\ >\\ \\:first-child):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0"
                ]
            ]
        , Css.Global.descendants
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose-sm\\ >\\ ul\\ >\\ li\\ p):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0.5714286em"
                , Css.property "margin-bottom" "0.5714286em"
                ]
            ]
...
prose_xl =
    Css.batch
        ...
        , Css.property "line-height" "1.8"
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose-xl\\ >\\ \\:last-child):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-bottom" "0"
                ]
            ]
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose-xl\\ >\\ \\:first-child):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0"
                ]
            ]
        , Css.Global.descendants
        ...
        , Css.Global.descendants
            [ Css.Global.selector ":where(.prose-xl\\ >\\ ul\\ >\\ li\\ p):not(:where(\\[class\\~=\"not-prose\"\\],\\[class\\~=\"not-prose\"\\]\\ \\*))"
                [ Css.property "margin-top" "0.8em"
                , Css.property "margin-bottom" "0.8em"
                ]
            ]
